                        ...
                        if ($user['status_data'] == 0) {
                            $this->session->set_flashdata('message', '
                                <div class="alert alert-success" role="alert">
                                    <Strong class="alert-heading">Login successful , <a href="user/edit_profile" class="alert-link">please complete the profile!</a></Strong>
                            ...
                            $this->session->set_flashdata('message', '
                            <div class="alert alert-success" role="alert">
                                <Strong class="alert-heading">Login successful </Strong>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'image' => 'assets/img/profile/user.png',
