    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="text-center">
                <h1 class="h4 mb-4 text-primary mt-4">Add Product</h1>
                <?= $this->session->flashdata('message'); ?>
            </div>
        </div>
        <div class="col-lg-7">
            <div class="p-3">
                <form class="user" method="post" action="<?= base_url(); ?>seller/add_product"
                    ...
                    <div class="form-group">
                        <input type="text"  class="form-control "
                            id="nama_product" required placeholder="Nama Produk" name="nama_produk">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number"  min="0" class="form-control "
                                id="stok" name="stok" required placeholder="Stok">
                            <?= form_error('stok', '<small class="text-danger pl-3" >', '</small> ') ?>
                        </div>
                    </div>
                    <div class="form-group ">
                        <select class="form-control" style="border-radius: 7px;height: 40px;margin-top: -10px;" name="status_produk"
                            id="status_produk">
                            <option value="1" selected disabled>Status Produk</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="Deskripsi Produk" name="deskripsi_produk" id="editor"></textarea>
        ...
        <div class="col-lg-5 pt-3">
            <center>
                ...
                <img class="imagePreview " src="<?= base_url('upload/box.png') ?>" id="output"></img>
        ...
        <input type="hidden" name="rekening_toko" value="<?= $user['no_rekening']; ?>" id="">
